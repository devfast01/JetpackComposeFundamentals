...
import xyz.teamgravity.sharedelementtransitiondemo.Screen

class SharedElementTransitionActivity_2 : ComponentActivity() {
                        ...
                        SharedTransitionLayout {
                            NavHost(
                                ...
                                composable(
                                    ...
                                    DetailScreen(
                                        image = entry.arguments?.getInt(Screen.Detail.Args.IMAGE)
                                            ?: 0,
